...
- **Release artifacts** — `ghcr.io/direktorbani/datasafe-*` images (tag e.g. `v1.0.3`), SBOM, cosign signatures on tags — verify with `cosign verify` (see [SECURITY.md](../../../SECURITY.md))
