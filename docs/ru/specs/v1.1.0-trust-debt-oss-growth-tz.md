...
**Ключевые пути:** `internal/security/urlpolicy/urlpolicy.go`, `internal/api/security_remediation_test.go`, `deploy/compose/docker-compose.audit.yml`.
...
| Compose | `deploy/compose/docker-compose.security-test.yml`, `.env.security-test` |
